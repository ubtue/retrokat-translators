{
	"translatorID": "3b036963-932d-4561-aeec-115ddebd7850",
	"label": "ubtue_PubMed Central",
	...
	"lastUpdated": "2022-08-02 07:20:21"
}
...
function lookupPMCIDs(ids, doc, pdfLink) {
	...
	ZU.doGet(newUri, function (text) {
		...
		for (var i in articles) {
			...
			if (ZU.xpathText(articles[i], '@articletype') != null) {
				if (ZU.xpathText(articles[i], '@articletype') == 'bookreview') newItem.tags.push('Book Review');
			}
